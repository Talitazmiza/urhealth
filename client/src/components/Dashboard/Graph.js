...
import HGraph, { History, hGraphConvert, calculateHealthScore } from 'new-hgraph';
// import data2017 from '../../data/2017.json';
import data2018 from '../../data/2018.json';
import datacoba from '../../data/coba_tanggal.json';
// import HGraph, {
//     History,
//     hGraphConvert,
...
function Graph() {
    ...
    const converted2017 = convertDataSet(datacoba);
    ...
    const [card, setCard] = useState(React.createRef());
    const [historyData, setHistoryData] = useState(yearData[0].data[0]);
    ...
    return (
        <>
            <div className="vis-container" style={{ height: historyOpen ? '50vh' : '100vh' }}>
                <HGraph
            ...
            <div className="card" style={{ top: historyOpen ? '50vh' : '100vh' }} ref={card}>
                <div>
                    <p>{ historyData.label }</p>
                    <p>{ historyData.value } { historyData.unitLabel }</p>
                    <History
                        width={ historySize }
